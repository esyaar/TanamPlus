  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.addUserButton} onPress={this.handleAddUser}>
          <Text style={styles.addUserText}>Tambah User</Text>
          <MaterialCommunityIcons name="plus" size={24} color="white" />
        </TouchableOpacity>

        <View style={styles.body}>
          <UserItem username="Esya Aulia" role="Penyuluh" onDelete={this.handleDelete} onEdit={this.handleEdit} />
          <UserItem username="Rahmadanti" role="Penyuluh" onDelete={this.handleDelete} onEdit={this.handleEdit} />
        </View>
      </View>
    );
  }
